...
const CryptoBasicPlan = ({ isOpen, onClose, plan, userID }) => {
  ...
  return (
    <Modal isOpen={isOpen} size="full">
      ...
      <ModalContent py="30px" color="text.black" maxW="400px">
        ...
        <ModalBody>
          <Flex justify="center">
            <Circle bg={planProps?.cryptoBasic.color} size="96px">
              <Image src={planProps?.cryptoBasic.img} w="10" />
            </Circle>
          </Flex>
          ...
          <HistoricalPerformance history={planProps?.cryptoBasic?.history} />
          <Box mt={"48px"}>
...
export default CryptoBasicPlan;
